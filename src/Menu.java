    ...
    int Run(String username, Network net){
        ...
        while (exit == 0)
        {
            ...
            switch (option)
            {
                ...
                case 2:
                    System.out.println("\n-----Whose wall would you like to visit?(Enter a number)-----");
                    user.showFriends();
                    System.out.println("\n-----Back [" + user.getFriends().size() + "]-----");
                    ...
                    switch (choice)
                    {
                        ...
                        case 2:
                            System.out.println("\n-----Select Message to Reply to? (Enter a number)-----");
                            user.getFriends().get(option).ShowMessages();
                            System.out.println("\n-----Back [" + user.getFriends().get(option).getMessages().size() + "]-----");
                            choice = Insert.nextInt();
                        ...
                        case 3:
                            System.out.println("\n-----Select a message to 'Like'? (Enter a number)-----");
                            user.getFriends().get(option).ShowMessages();
                ...
                case 3:
                    System.out.println("\n-----Select someone to send a Friend Request to? (Enter a number)-----");
                    user.addNotFriends();
                    user.showNotFriends();
                    option = Insert.nextInt();
                ...
                case 4:
                    System.out.println("\n-----Select someone to respond to their Friend Request? (Enter a number)-----");
                    user.ShowAitimata();
                    System.out.println("\n-----Back [" + user.getAitimataAutoi().size() + "]-----");
                    option = Insert.nextInt();
                ...
                case 6:
                    exit = 1;
                    System.out.println("\n------You have successfully logged out of Fakebook------");
                    break;
                ...
                default:
                    System.out.println("\nPlease Enter a valid number. (From 1 to 8)");
            }
        }
        return exit;
    }
